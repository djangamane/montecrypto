...
const ThankYou: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Mark paid locally (client-side placeholder; replace with server verification later)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black flex items-center justify-center p-6 text-center text-white">
      <div className="max-w-lg w-full space-y-6 bg-gray-900/80 border border-arcade-cyan/40 p-6 rounded-lg shadow-lg">
        <h1 className="text-3xl font-retro text-arcade-cyan">Payment Confirmed</h1>
        ...
        <div className="space-y-2 text-left">
          ...
          <button
            ...
            className="w-full mt-1 px-4 py-2 bg-arcade-cyan text-black font-retro rounded shadow hover:scale-105 transition-transform"
          >
            Confirm Access
          </button>
        </div>
        <a
          href="/"
          className="inline-flex items-center justify-center px-4 py-3 bg-arcade-cyan text-black font-retro rounded shadow hover:scale-105 transition-transform"
        >
