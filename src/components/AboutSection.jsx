    ...
    <section id="about" className="px-6 py-16">
      <div className="mx-auto grid max-w-6xl gap-10 rounded-3xl border border-brand-muted/30 bg-white/85 p-10 shadow-lg md:grid-cols-[0.9fr,1.1fr]">
        <div className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-brand-link/70">Founder story</p>
          <h2 className="text-3xl font-heading uppercase text-brand-text">Making risk visible since 2017</h2>
          <p className="text-base leading-relaxed text-brand-muted">
            I taught my first crypto course in 2017, warned students early about BitConnect, and ran an ETH/XMR
            mining setup with Houston partners. After building AI systems for nonprofits, I returned to crypto with
        ...
        <div className="rounded-3xl border border-dashed border-brand-muted/40 bg-brand-bg/70 p-6 text-sm leading-relaxed text-brand-muted">
          ...
          <ul className="mt-4 space-y-3">
            ...
            <li>• Clear disclaimers — this is educational, not financial advice.</li>
